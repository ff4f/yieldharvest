...
import RealTimeMilestones from './RealTimeMilestones';
  ...
  const renderMilestones = () => (
    <div className="space-y-6">
      ...
      <RealTimeMilestones 
        ...
        serial={deal?.nft?.serialNumber}
        dealId={deal?.id}
      />
      
      {/* Static Milestone Grid */}
      <div className="space-y-4">
        <h4 className="text-lg font-semibold text-foreground">Milestone Overview</h4>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
